Namespace SetSelection
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Dim seriesPoint3 As New DevExpress.XtraCharts.SeriesPoint("c", New Object() { (CObj(3R))})
			Dim seriesPoint4 As New DevExpress.XtraCharts.SeriesPoint("d", New Object() { (CObj(2.3R))})
			Dim seriesPoint5 As New DevExpress.XtraCharts.SeriesPoint("e", New Object() { (CObj(0.5R))})
			Dim seriesPoint6 As New DevExpress.XtraCharts.SeriesPoint("f", New Object() { (CObj(7R))})
...
'ORIGINAL LINE: this.btnSeriesPoint.Click += new System.EventHandler(this.btnSeriesPoint_Click);
			' 
			' btnAxis
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnAxis.Click += new System.EventHandler(this.btnAxis_Click);
			' 
			' btnDiagram
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnDiagram.Click += new System.EventHandler(this.btnDiagram_Click);
			' 
			' Form1
			' 
